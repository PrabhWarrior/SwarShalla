...
const getAllUsers = async (_req: any, res: Response) => {
  try {
    ...
    return sendSuccess(res, users, "Users fetched successfully", StatusCodes.OK);
  } catch (error: any) {
    return sendError(res, "Failed to fetch users", StatusCodes.INTERNAL_SERVER_ERROR, error.message);
  }
};
...
const getUserById = async (req: any, res: Response) => {
  try {
    ...
    return sendError(res, "Failed to fetch user", StatusCodes.INTERNAL_SERVER_ERROR, error.message);
  }
};
...
const createUser = async (req: any, res: Response) => {
  try {
    ...
    return sendError(res, "Failed to create user", StatusCodes.INTERNAL_SERVER_ERROR, error.message);
  }
};
...
const updateUser = async (req: any, res: Response) => {
  try {
    ...
    return sendError(res, "Failed to update user", StatusCodes.INTERNAL_SERVER_ERROR, error.message);
  }
};
...
const deleteUser = async (req: any, res: Response) => {
  try {
    ...
    if (!deleted) return sendError(res, "User not found", StatusCodes.NOT_FOUND);

    return sendSuccess(res, null, "User deleted successfully", StatusCodes.OK);
  } catch (error: any) {
    return sendError(res, "Failed to delete user", StatusCodes.INTERNAL_SERVER_ERROR, error.message);
  }
};
